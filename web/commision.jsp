<%-- 
    Document   : Commisions
    Created on : 8 Sep, 2016, 7:15:51 AM
    Author     : rocky_000
--%>
...
<html>
    <head>
        ...
        <script src="js/commision.js" type="text/javascript"></script>
    </head>
        ...
        <div class="content-page">
            ...
            <div class="content">
				...
				<div class="page-heading">
            		...
            		<h3>VIEW ALL YOUR COMMISION DETAILS &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a class="btn btn-primary md-trigger" data-modal="form-modal">TO DATE</a>
						...
						<div class="widget">
							...
							<br>					
								<div class="table-responsive">
									...
									<table id="commisionList" class="table table-striped table-bordered" cellspacing="0" width="100%">
								        <thead>
								           <tr>
								                <th>CHALLAN NO:</th>
								                <th>DATE:</th>
