<%-- 
    Document   : forms
    Created on : 2 Sep, 2016, 9:46:28 PM
    Author     : rocky_000
--%>
...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Form Wizard | Coco - Responsive Bootstrap Admin Template</title>   
