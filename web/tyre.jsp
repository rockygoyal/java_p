<%-- 
    Document   : tyre
    Created on : 1 Oct, 2016, 9:34:52 AM
    Author     : rocky_000
--%>
...
<!-- Top Bar End -->
    ...
    <div class="right side-menu">
		...
		<div class="md-close-btn"><a class="md-close"><i class="fa fa-times"></i></a></div>
			<h3><strong>CHECK TYRE DETAILS BY DATE</strong></h3>
			<div>
				<div class="row">
					<div class="col-sm-6">
        ...
        <div class="content-page">
            ...
            <div class="content">
				...
				<div class="page-heading">
            		<h1><i class='fa fa-table'></i> TYRE DETAILS</h1>
            		<h3>VIEW ALL YOUR TYRE DETAILS DATEWISE&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a class="btn btn-primary md-trigger" data-modal="form-modal">SEARCH</a></h3>            	</div>
