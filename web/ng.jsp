<%-- 
    Document   : ng
    Created on : 8 Sep, 2016, 7:29:18 AM
    Author     : rocky_000
--%>
        ...
        <div class="content-page">
            ...
            <div class="content">
				...
				<div class="page-heading">
            		<h1><i class='fa fa-table'></i>N.G</h1>
            		<h3>VIEW ALL YOUR NG DETAILS</h3>   <a class="btn btn-primary md-trigger" data-modal="form-modal">SEARCH.</a>          	</div>
