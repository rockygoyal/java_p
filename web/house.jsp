<%-- 
    Document   : house
    Created on : 1 Oct, 2016, 9:35:09 AM
    Author     : rocky_000
--%>
...
<!-- Top Bar End -->
    ...
    <div class="right side-menu">
		...
		<div class="md-close-btn"><a class="md-close"><i class="fa fa-times"></i></a></div>
			<h3><strong>CHECK EXPENSES BY DATE</strong></h3>
			<div>
				<div class="row">
					<div class="col-sm-6">
        ...
        <div class="content-page">
            ...
            <div class="content">
				...
				<div class="page-heading">
            		...
            		<h3>VIEW ALL YOUR COMMISIONS DATEWISE&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a class="btn btn-primary md-trigger" data-modal="form-modal">SEARCH</a></h3>            	</div>
