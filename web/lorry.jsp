<%-- 
    Document   : lorry
    Created on : Oct 1, 2016, 9:26:32 PM
    Author     : tarasankar
--%>
...
<%
    try {
        ...
        PreparedStatement ps = con.prepareStatement("SELECT lorry_no FROM lorry_details WHERE is_active=1");
        ResultSet rs = ps.executeQuery();
        while (rs.next()) {
            s.add(rs.getString("lorry_no"));
        }
