<%-- 
    Document   : receivechallan
    Created on : 1 Oct, 2016, 8:47:53 AM
    Author     : rocky_000
--%>
						...
						<form role="form">
							...
							<label class="control-label">UNLOADING DATE:</label>
							  <input type="text" class="form-control datepicker-input">
                                                    ...
                                                    <div class="form-group">
							<label class="control-label">SIGN CHALLAN RECEIVE DATE:</label>
							  <input type="text" class="form-control datepicker-input">
						  </div>

						  
						  <button type="submit" class="btn btn-default">RECEIVE</button>
						</form>
					</div>
        ...
        <div class="content-page">
            ...
            <div class="content">
				...
				<div class="page-heading">
            		<h1><i class='fa fa-table'></i>RECEIVE CHALLAN</h1>
            		<h3>VIEW ALL YOUR DUE CHALLANS</h3>            	</div>
								        ...
								        <thead>
								            <tr>
								                ...
								                <th>LORRY NO:</th>
                                                                        ...
                                                                        <td>**********</td>
                                                                        <td>**********</td>
                                                                        <td><a class="btn btn-primary md-trigger" data-modal="form-modal2">RECEIVE</a></td>
                                                                            </tr>
