<%-- 
    Document   : difference
    Created on : 1 Oct, 2016, 9:34:02 AM
    Author     : rocky_000
--%>
...
<html>
    <head>
        ...
        <script src="js/difference.js" type="text/javascript"></script>
    </head>
            ...
            <div class="content-page">
                ...
                <div class="content">
                    ...
                    <div class="page-heading">
                        <h1><i class='fa fa-table'></i> COMISSIONS</h1>
                        <h3>VIEW ALL YOUR DIFFERENCE DETAILS &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a class="btn btn-primary md-trigger" data-modal="form-modal">TO DATE</a>
                                ...
                                <div class="widget-content">
                                    ...
                                    <div class="table-responsive">
                                        <form class='form-horizontal' role='form'>
                                            <table id="differenceList" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                                <thead>
                                                    <tr>
                                                        <th>LORRY NO:</th>
                                                        <th>DATE:</th>
