<%-- 
    Document   : office
    Created on : 1 Oct, 2016, 9:34:22 AM
    Author     : rocky_000
--%>
...
<!-- Top Bar End -->
    ...
    <div class="right side-menu">
		...
		<div class="md-close-btn"><a class="md-close"><i class="fa fa-times"></i></a></div>
			<h3><strong>CHECK OFFICE EXPENSES</strong></h3>
			<div>
				<div class="row">
					<div class="col-sm-6">
        ...
        <div class="content-page">
            ...
            <div class="content">
				...
				<div class="page-heading">
            		<h1><i class='fa fa-table'></i>OFFICE EXPENSES</h1>
                              <h3>VIEW ALL YOUR OFFICE EXPENSE &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a class="btn btn-primary md-trigger" data-modal="form-modal">SEARCH</a>
