...
<!-- Top Bar End -->
    ...
    <div class="right side-menu">
		...
		<div class="md-close-btn"><a class="md-close"><i class="fa fa-times"></i></a></div>
			<h3><strong>CHECK CHALLANS BY DATE</strong></h3>
			<div>
				<div class="row">
					<div class="col-sm-6">
		...
		<div class="md-content">
		<div class="md-close-btn"><a class="md-close"><i class="fa fa-times"></i></a></div>
			<h3><strong>CHECK CHALLANS BY TRANPORT NAME</strong></h3>
			<div>
				<div class="row">
					<div class="col-sm-6">
		...
		<div class="md-content">
		<div class="md-close-btn"><a class="md-close"><i class="fa fa-times"></i></a></div>
			<h3><strong>CHECK CHALLANS BY LORRY NUMBER</strong></h3>
			<div>
				<div class="row">
					<div class="col-sm-6">
        ...
        <div class="content-page">
            ...
            <div class="content">
				...
				<div class="page-heading">
            		<h1><i class='fa fa-table'></i>CHALLANS</h1>
            		<h3>VIEW ALL CHALLANS &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a class="btn btn-primary md-trigger" data-modal="form-modal">TO DATE</a>
						...
						<div class="widget">
							...
							<br>					
								<div class="table-responsive">
									...
									<table id="balanceList" class="table table-striped table-bordered" cellspacing="0" width="100%">
								        <thead>
								            <tr>
									                <th>Challan no</th>
									                <th>Date</th>
